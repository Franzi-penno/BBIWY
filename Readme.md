...
* 'llama3.1:8b' herunterladen

dieser Code in Terminal einfügen:
```bash
ollama pull llama3.1:8b```

* Modelfile erzeugen (Texteditor)
```bash
FROM llama3.1:8b
...
```bash
ollama crearte peterparker -f Modelfile
```
* Chatbot aus Modelfile erzeugen 